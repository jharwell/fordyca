/**
 * @file energy_partitioning_controller.hpp
 *
...
#ifndef INCLUDE_FORDYCA_CONTROLLER_DEPTH1_ENERGY_PARTITIONING_CONTROLLER_HPP_
#define INCLUDE_FORDYCA_CONTROLLER_DEPTH1_ENERGY_PARTITIONING_CONTROLLER_HPP_
...
namespace ee_methods {
namespace individual {
class ee_battery;
class ee_probability;
class ee_timing;
}
namespace combo {
class ee_all;
class ee_battery_probability;
class ee_battery_timing;
}
}
 ...
 ******************************************************************************/
/**
 * @class energy_partitioning_controller
 * @ingroup controller depth1
 *
 * @brief A energy_partitioning controller that switches between \ref generalist,
 ...
 */
class energy_partitioning_controller : public depth0::stateful_controller,
                                       public er::client<energy_partitioning_controller>,
                                       public visitor::visitable_any<energy_partitioning_controller>,
                                       public rcppsw::metrics::tasks::bi_tdgraph_metrics {
 public:
  energy_partitioning_controller(void);
  ~energy_partitioning_controller(void) override;
 ...
 protected:
  ...
  /*
   * The \ref energy_partitioning_controller owns the executive, but derived
...
#endif /* INCLUDE_FORDYCA_CONTROLLER_DEPTH1_ENERGY_PARTITIONING_CONTROLLER_HPP_ */
