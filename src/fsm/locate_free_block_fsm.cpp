/**
 * @file locate_free_block_fsm.cpp
 *
 ...
 ******************************************************************************/
locate_free_block_fsm::locate_free_block_fsm(
...
HFSM_STATE_DEFINE(locate_free_block_fsm, acquire_block, state_machine::event_data) {
...
HFSM_EXIT_DEFINE(locate_free_block_fsm, exit_acquire_block) {
  m_vector_fsm.task_reset();
  m_explore_fsm.init();
}
FSM_STATE_DEFINE(locate_free_block_fsm, finished, state_machine::no_event_data) {
 ...
 ******************************************************************************/
void locate_free_block_fsm::init(void) {
  base_foraging_fsm::init();
  m_vector_fsm.task_reset();
  m_explore_fsm.init();
} /* init() */

void locate_free_block_fsm::update_state(uint8_t new_state) {
...
void locate_free_block_fsm::acquire_known_block(
...
bool locate_free_block_fsm::acquire_free_block(void) {
...
void locate_free_block_fsm::task_execute(void) {
