...
HFSM_STATE_DEFINE(foraging_fsm, start, state_machine::event_data) {
  ...
  HFSM_STATE_DEFINE(foraging_fsm, block_to_nest, state_machine::event_data) {
...
__const FSM_STATE_DEFINE_ND(foraging_fsm, finished) {
  return controller::foraging_signal::HANDLED;
}
 ...
 * Base Diagnostics
 ******************************************************************************/
bool foraging_fsm::is_exploring_for_block(void) const {
  return m_block_fsm.is_exploring_for_block();
} /* is_exploring_for_block() */

bool foraging_fsm::is_avoiding_collision(void) const {
  return m_block_fsm.is_avoiding_collision();
} /* is_avoiding_collision() */

bool foraging_fsm::is_transporting_to_nest(void) const {
 ...
 * Depth0 Diagnostics
 ******************************************************************************/
bool foraging_fsm::is_acquiring_block(void) const {
  return m_block_fsm.is_acquiring_block();
} /* is_acquiring_block() */

bool foraging_fsm::is_vectoring_to_block(void) const {
...
void foraging_fsm::task_execute(void) {
