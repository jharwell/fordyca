...
random_block_distributor::random_block_distributor(
    ...
    : base_block_distributor(server),
      ...
      m_grid(grid) {
  if (ERROR == client::attmod("random_block_dist")) {
    insmod("random_block_dist", er::er_lvl::DIAG, er::er_lvl::OFF);
  }
}
 ...
 * Member Functions
 ******************************************************************************/
bool random_block_distributor::distribute_blocks(block_vector& blocks,
                                                 entity_list& entities) {
  ER_NOM("Distributing %zu blocks in area: xrange=[%zu-%zu], yrange=[%zu-%zu]",
         blocks.size(),
...
bool random_block_distributor::find_avail_coord(
