...
void task_parser::parse(argos::TConfigurationNode& node) {
  ...
  argos::GetNodeAttribute(task_node, "abort_reactivity",
                          m_params->tasks.abort_reactivity);
  argos::GetNodeAttribute(task_node, "abort_offset",
                          m_params->tasks.abort_offset);
  argos::GetNodeAttribute(task_node, "partition_reactivity",
                          m_params->tasks.partition_reactivity);
  argos::GetNodeAttribute(task_node, "partition_offset",
  ...
  argos::GetNodeAttribute(task_node, "always_partition",
                          m_params->tasks.always_partition);
  argos::GetNodeAttribute(task_node, "never_partition",
                          m_params->tasks.never_partition);

  argos::GetNodeAttribute(task_node, "init_random_estimates",
