 ...
 */
class goal_acq_locs_metrics_collector : public grid2D_avg_metrics_collector {
 public:
  /**
  ...
  std::vector<rmath::vector2u> collect_cells(
      const rmetrics::base_metrics& metrics) const override;
};
