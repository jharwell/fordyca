/**
 * \file foraging_perception_model.hpp
 *
...
#ifndef INCLUDE_FORDYCA_DS_FORAGING_PERCEPTION_MODEL_HPP_
#define INCLUDE_FORDYCA_DS_FORAGING_PERCEPTION_MODEL_HPP_
...
#include "fordyca/ds/access_tracked_objects.hpp"
 ...
 ******************************************************************************/
/**
 * \class foraging_perception_model
 * \ingroup ds
 *
 * \brief Base class defining the interface for all perception models in
 * FORDYCA.
 */
template <typename TTrackedBlockContainer, typename TTrackedCacheContainer>
class foraging_perception_model : public csperception::base_perception_model,
                                  public access_known_objects,
                                  public access_tracked_objects<TTrackedBlockContainer,
                           TTrackedCacheContainer>,
                                  public rer::client<foraging_perception_model<TTrackedBlockContainer,
                                                                               TTrackedCacheContainer>> {
 public:
  using tracked_objects_type = access_tracked_objects<TTrackedBlockContainer,
                                                      TTrackedCacheContainer>;
  using typename tracked_objects_type::block_container_type;
  using typename tracked_objects_type::cache_container_type;
  using typename tracked_objects_type::tracked_cache_type;
  using typename tracked_objects_type::tracked_block_type;

  access_known_objects* known_objects(void) { return this; }
  tracked_objects_type* tracked_objects(void) { return this; }

  foraging_perception_model(void)
      : ER_CLIENT_INIT("fordyca.ds.foraging_perception_model") {}

  /* known_objects overrides */
...
#endif /* INCLUDE_FORDYCA_DS_FORAGING_PERCEPTION_MODEL_HPP_ */
