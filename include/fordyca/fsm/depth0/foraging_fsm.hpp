...
class foraging_fsm : public base_foraging_fsm,
 ...
 private:
  ...
  HFSM_STATE_DECLARE(foraging_fsm, start, state_machine::event_data);
  HFSM_STATE_DECLARE(foraging_fsm, block_to_nest, state_machine::event_data);
  HFSM_STATE_DECLARE_ND(foraging_fsm, finished);
