 ...
 */
class cache_acquisition_validator : public rcppsw::er::client<cache_acquisition_validator> {
 public:
  ...
  cache_acquisition_validator& operator=(const cache_acquisition_validator& v) = delete;
