...
#ifndef INCLUDE_FORDYCA_FSM_DEPTH1_ACQUIRE_NEW_CACHE_FSM_HPP_
#define INCLUDE_FORDYCA_FSM_DEPTH1_ACQUIRE_NEW_CACHE_FSM_HPP_
 ...
 * cache or via random exploration). Once the chosen new cache has been acuired,
 * it signals that it has completed its task.
 */
class acquire_new_cache_fsm : public depth1::acquire_cache_fsm {
 public:
...
#endif /* INCLUDE_FORDYCA_FSM_DEPTH1_ACQUIRE_NEW_CACHE_FSM_HPP_ */
