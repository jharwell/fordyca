...
#ifndef INCLUDE_FORDYCA_STRATEGY_CONFIG_EXPLORE_PARSER_HPP_
#define INCLUDE_FORDYCA_STRATEGY_CONFIG_EXPLORE_PARSER_HPP_
...
#endif /* INCLUDE_FORDYCA_STRATEGY_CONFIG_EXPLORE_PARSER_HPP_ */
