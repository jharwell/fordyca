...
#ifndef INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_STATIC_CACHE_LOCS_CALCULATOR_HPP_
#define INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_STATIC_CACHE_LOCS_CALCULATOR_HPP_
...
class static_cache_locs_calculator : public rer::client<static_cache_locs_calculator> {
 public:
  static_cache_locs_calculator(void)
      : ER_CLIENT_INIT("fordyca.argos.support.d1.static_cache_locs_calculator") {}
...
#endif /* INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_STATIC_CACHE_LOCS_CALCULATOR_HPP_ */
