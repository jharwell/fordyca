 ...
 */
#ifndef INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_ROBOT_CONFIGURER_ADAPTOR_HPP_
#define INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_ROBOT_CONFIGURER_ADAPTOR_HPP_
...
using configurer_map_type = rds::type_map<
  rmpl::typelist_wrap_apply<fcontroller::d1::cognitive_typelist,
                             robot_configurer,
...
NS_END(detail, d1, support, argos, fordyca);

#endif /* INCLUDE_FORDYCA_ARGOS_SUPPORT_D1_ROBOT_CONFIGURER_ADAPTOR_HPP_ */
