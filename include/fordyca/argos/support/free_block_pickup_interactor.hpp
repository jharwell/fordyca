...
#ifndef INCLUDE_FORDYCA_ARGOS_SUPPORT_FREE_BLOCK_PICKUP_INTERACTOR_HPP_
#define INCLUDE_FORDYCA_ARGOS_SUPPORT_FREE_BLOCK_PICKUP_INTERACTOR_HPP_
...
class free_block_pickup_interactor final :
    ...
    public cainteractors::free_block_pickup<
  TController,
  TControllerSpecMap> {
 public:
  ...
  void robot_previsit_hook(TController& controller,
    ...
    controller.block_manip_recorder()->record(
        fmetrics::blocks::block_manip_events::ekFREE_PICKUP, penalty.penalty());
  }
};

NS_END(support, argos, fordyca);

#endif /* INCLUDE_FORDYCA_ARGOS_SUPPORT_FREE_BLOCK_PICKUP_INTERACTOR_HPP_ */
