...
#ifndef INCLUDE_FORDYCA_CONTROLLER_DEPTH0_STATELESS_CONTROLLER_HPP_
#define INCLUDE_FORDYCA_CONTROLLER_DEPTH0_STATELESS_CONTROLLER_HPP_
...
namespace fsm { namespace depth0 { class stateless_fsm; }}
 ...
 */
class stateless_controller : public base_controller,
                                      public er::client<stateless_controller>,
                                      public metrics::fsm::movement_metrics,
                                      public metrics::fsm::goal_acquisition_metrics,
                                      public metrics::blocks::manipulation_metrics,
                                      public fsm::block_transporter,
                                      public visitor::visitable_any<stateless_controller> {
 public:
  stateless_controller(void);
  ~stateless_controller(void) override;
 ...
 private:
  ...
  std::unique_ptr<fsm::depth0::stateless_fsm> m_fsm;
  // clang-format on
};

NS_END(depth0, controller, fordyca);

#endif /* INCLUDE_FORDYCA_CONTROLLER_DEPTH0_STATELESS_CONTROLLER_HPP_ */
