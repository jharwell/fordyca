/**
 * @file energy_actuator_manager.hpp
 *
...
#ifndef INCLUDE_FORDYCA_CONTROLLER_ENERGY_ACTUATOR_MANAGER_HPP_
#define INCLUDE_FORDYCA_CONTROLLER_ENERGY_ACTUATOR_MANAGER_HPP_
