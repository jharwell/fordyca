...
class bitd_dpo_controller : public depth0::dpo_controller,
 ...
 public:
  ...
  const cognitive::cache_sel_matrix* cache_sel_matrix(void) const {
    return m_cache_sel_matrix.get();
  }
  cognitive::cache_sel_matrix* cache_sel_matrix(void) {
    return m_cache_sel_matrix.get();
  }
 ...
 private:
  ...
  std::unique_ptr<cognitive::cache_sel_matrix> m_cache_sel_matrix;
