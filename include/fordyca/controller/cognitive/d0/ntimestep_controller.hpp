...
#ifndef INCLUDE_FORDYCA_CONTROLLER_COGNITIVE_D0_NTIMESTEP_CONTROLLER_HPP_
#define INCLUDE_FORDYCA_CONTROLLER_COGNITIVE_D0_NTIMESTEP_CONTROLLER_HPP_
 ...
 */
class ntimestep_controller : public cognitive::cognitive_controller,
                       public rer::client<ntimestep_controller> {
 public:
 ...
 protected:
   ...
   */
  void shared_init(const config::perceptive_controller_repository& config_repo) RCPPSW_COLD;
 ...
 private:
   ...
   */
  void private_init(const config::perceptive_controller_repository& config_repo) RCPPSW_COLD;
