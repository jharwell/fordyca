...
template <typename T>
using is_d0 =
    typename boost::mpl::contains<controller::d0::typelist, T>::type;

template <typename T>
using is_d1 =
    typename boost::mpl::contains<controller::d1::typelist, T>::type;

template <typename T>
using is_d2 =
    typename boost::mpl::contains<controller::d2::typelist, T>::type;
