...
#ifndef INCLUDE_FORDYCA_CONFIG_ARENA_BLOCK_MANIFEST_HPP_
#define INCLUDE_FORDYCA_CONFIG_ARENA_BLOCK_MANIFEST_HPP_
...
#endif /* INCLUDE_FORDYCA_CONFIG_ARENA_BLOCK_MANIFEST_HPP_ */
