...
#ifndef INCLUDE_FORDYCA_CONFIG_PERCEPTION_PHEROMONE_CONFIG_HPP_
#define INCLUDE_FORDYCA_CONFIG_PERCEPTION_PHEROMONE_CONFIG_HPP_
...
#endif /* INCLUDE_FORDYCA_CONFIG_PERCEPTION_PHEROMONE_CONFIG_HPP_ */
