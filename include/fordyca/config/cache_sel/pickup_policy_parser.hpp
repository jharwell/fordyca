...
#ifndef INCLUDE_FORDYCA_CONFIG_CACHE_SEL_PICKUP_POLICY_PARSER_HPP_
#define INCLUDE_FORDYCA_CONFIG_CACHE_SEL_PICKUP_POLICY_PARSER_HPP_
...
#endif /* INCLUDE_FORDYCA_CONFIG_CACHE_SEL_PICKUP_POLICY_PARSER_HPP_ */
