 ...
 */
class static_cache_parser: public rconfig::xml::xml_config_parser {
 public:
  ...
  std::shared_ptr<static_cache_config> config_get(void) const {
    return m_config;
  }
 ...
 private:
  ...
  /* clang-format off */
  std::shared_ptr<static_cache_config> m_config{nullptr};
  /* clang-format on */
};
