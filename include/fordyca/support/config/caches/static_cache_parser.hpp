...
#ifndef INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_STATIC_CACHE_PARSER_HPP_
#define INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_STATIC_CACHE_PARSER_HPP_
...
class static_cache_parser final: public rer::client<static_cache_parser>,
 ...
 public:
  ...
  static_cache_parser(void)
      : ER_CLIENT_INIT("fordyca.support.config.caches.static_cache_parser") {}
...
#endif /* INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_STATIC_CACHE_PARSER_HPP_ */
