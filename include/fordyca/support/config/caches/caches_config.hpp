...
#ifndef INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_CACHES_CONFIG_HPP_
#define INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_CACHES_CONFIG_HPP_
...
#include "fordyca/support/config/caches/static_cache_config.hpp"
#include "fordyca/support/config/caches/dynamic_cache_config.hpp"
...
NS_END(arena, config, support, fordyca);

#endif /* INCLUDE_FORDYCA_SUPPORT_CONFIG_CACHES_CACHE_CONFIG_HPP_ */
