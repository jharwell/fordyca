/**
 * \file cache_creation_verifier.hpp
 *
...
#ifndef INCLUDE_FORDYCA_SUPPORT_CACHE_CREATION_VERIFIER_HPP_
#define INCLUDE_FORDYCA_SUPPORT_CACHE_CREATION_VERIFIER_HPP_
 ...
 */
class cache_creation_verifier : public rer::client<cache_creation_verifier> {
 public:
  cache_creation_verifier(carena::caching_arena_map* map,
                     const rtypes::spatial_dist& cache_dim,
                     bool strict_constraints);

  cache_creation_verifier(const cache_creation_verifier&) = delete;
  cache_creation_verifier& operator=(const cache_creation_verifier&) = delete;
...
#endif // INCLUDE_FORDYCA_SUPPORT_CACHE_CREATION_VERIFIER_HPP_
